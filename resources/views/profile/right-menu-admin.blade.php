...
<hr>
        ...
        <div class="d-navigation">
            <ul id="side-menu">
                ...
                <li @if (Route::is('comments')) class="active" @endif><a href="{{route('comments')}}" style="font-family: sans-serif;"><i class="fas fa-comment-alt"></i>فعال یا غیرفعال کردن کامنت ها</a></li>
